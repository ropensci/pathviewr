...
examples of how to import and clean other types of data, see the data import and
cleaning vignette. [link to vignette]
...
will use one of two "all-in-one" functions: `clean_viewr()`. See the
data import and cleaning vignette for the full pipeline and the other
"all-in-one" function.[link to vignette]
...
in the data. See the Managing Frame Gaps vignette for more information on
trajectory definition and frame gaps. [link to vignette]
...
these functions, see the Visual Perception Functions vignette. [link to
vignette]
...
Please see the Visual Perception Functions for more examples of visualizing
calculations. [link to vignette]
