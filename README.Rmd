...
Baliga VB, Armstrong MS, Press ER (2021). _pathviewr: Tools to import, clean, and visualize animal movement data in R_. R package version 1.0.0, [https://github.com/ropensci/pathviewr](https://github.com/ropensci/pathviewr).
