...
V-shaped tunnel in which the origin (0,0,0) was set to the height of the perches
that sit 0.3855m above the height of the vertex. The lateral walls were angled
±45˚ from the vertical axis. The visual stimulus on the positive side of the
tunnel (where `position_width` values > 0) were horizontal sine wave gratings 
with a cycle length of 0.1m on the screen. The visual stimulus on the 
...
the origin. The visual stimuli were the same as in the motive example, though now with a stimulus on the front wall of 0.2m cycle length.
...
<<<<<<< HEAD
To calculate an estimation of the visual angles percieved by the subject, we will use `calc_vis_angle_V` and not `calc_vis_angle_box`.
=======
...
>>>>>>> 3bcc644d385ae21f7191c1a99df8796cc410e687
...
closer it gts to the positive wall.
