...
### **Spatial frequency**
```{r motive_V_sf_pos, fig.height=7, fig.width=7}
...
```{r motive_V_sf_neg, fig.height=7, fig.width=7}
ggplot(motive_V_sf, aes(x = position_width, y = position_height)) +
...
### **Visual angles**
```{r motive_V_angles_pos, fig.height=7, fig.width=7}
...
```{r motive_V_angles_neg, fig.height=7, fig.width=7}
ggplot(motive_V_angles, aes(x = position_width, y = position_height)) +
