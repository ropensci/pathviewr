...
motive_data <-
  read_motive_csv(
    system.file("extdata", "july-29_group-I_16-20_truncated.csv",
                package = 'pathviewR')
  )
...
Isolating trajectories is handled via he `separate_trajectories()` function in
...
For example, if the user keeps `select_x_percent = TRUE` as an arugment in
...
the default value of 33 percent, an additional arugment should be supplied to
