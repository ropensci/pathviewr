...
selecing 50 percent would start from the center of the tunnel and move 25% of
...
gaps are allowed (movement must be continuous with no gaps).
```{r separate_examples}
motive_labeled <-
  motive_selected %>% 
...
the selected region of interst. The `span` parameter of this function handles
...
judgement. Should you desire to set it lower (which you can), you may instead
