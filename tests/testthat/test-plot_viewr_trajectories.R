...
test_that("plot info (axes, titles, etc.) is correct", {
  expect_match(obj_name_trajs[9], "pathviewR_motive_example_data.csv_device05_1")
...
#   # multi_plot_default <- function() plot_viewr_trajectories(motive_full,
#   #                                                          plot_axes = c("length", "width"),
#   #                                                          multi_plot = TRUE)
#   # vdiffr::expect_doppelganger("multi plot default", multi_plot_default)
